        ...
        <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                    ...
                    <div class="card-body">
                        <form role="form" action="/sign-in" method="post" class="text-start">
                            ...
                            <div>
                                <p class="text-danger text-sm text-center"><?php echo $message ?></p>
                            </div>
                            ...
                            <p class="mt-4 text-sm text-center">
                                ...
                                <a href="register" class="text-primary text-gradient font-weight-bold">Cliquez
                                    ici</a>
                            </p>
                        </form>
                    </div>
